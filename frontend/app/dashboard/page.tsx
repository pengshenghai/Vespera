  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900 dark:text-white">Overview</h2>
          <p className="text-neutral-500 dark:text-neutral-400 mt-1">Welcome back. Here is the latest on your rentals.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-3xl shadow-sm p-6 border border-neutral-200/60 dark:border-neutral-700/60 flex flex-col justify-between group hover:shadow-md transition-shadow">
          ...
          <div className="mt-4">
            <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Next Payment Due</p>
            <div className="flex items-baseline gap-2 mt-1">
              <h3 className="text-3xl font-bold tracking-tight text-neutral-900 dark:text-white">$1,200</h3>
              <span className="text-sm text-neutral-500 dark:text-neutral-400">/mo</span>
            </div>
            <p className="text-sm text-neutral-600 dark:text-neutral-300 mt-2 truncate">Sunset Apartments, Unit 4B</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-3xl shadow-sm p-6 border border-neutral-200/60 dark:border-neutral-700/60 flex flex-col justify-between group hover:shadow-md transition-shadow">
          ...
          <div className="mt-4">
            <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Active Lease</p>
            <h3 className="text-xl font-bold tracking-tight text-neutral-900 dark:text-white mt-1">12 Months</h3>
            ...
            <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-2">7 months remaining</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-3xl shadow-sm p-6 border border-neutral-200/60 dark:border-neutral-700/60 flex flex-col justify-between sm:col-span-2 lg:col-span-1 group hover:shadow-md transition-shadow">
          ...
          <div className="mt-4 flex flex-col pt-1">
             ...
             <div className="flex items-baseline justify-between mt-3">
              <div>
                <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Rent Paid This Year</p>
                 <h3 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white mt-0.5">$8,400</h3>
              </div>
             </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-3xl shadow-sm border border-neutral-200/60 dark:border-neutral-700/60 overflow-hidden">
        <div className="px-6 py-5 border-b border-neutral-100 dark:border-neutral-700/60 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-neutral-900 dark:text-white">Active Agreements</h3>
          <button className="text-sm font-medium text-brand-blue hover:text-brand-blue-dark dark:text-blue-400 dark:hover:text-blue-300">View All</button>
        </div>
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
             ...
             <tbody className="divide-y divide-neutral-100 dark:divide-neutral-700/40">
               {mockAgreements.map((agreement) => (
                 <tr key={agreement.id} className="hover:bg-neutral-50/50 dark:hover:bg-neutral-700/20 transition-colors">
