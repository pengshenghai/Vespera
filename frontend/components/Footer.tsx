        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 sm:mb-12">
            ...
            <div className="lg:col-span-1 sm:col-span-2">
              <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Chioma</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
                Reimagining rentals with blockchain security. Transparent, fast, and trusted.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <a href="#" className="text-gray-300 hover:text-white transition text-sm sm:text-base">
                    Browse Homes
                  </a>
                </li>
                <li>
