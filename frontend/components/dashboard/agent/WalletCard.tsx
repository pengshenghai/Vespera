    ...
    return (
        <div className="bg-linear-to-br from-blue-600 to-blue-500 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="mb-6">
                    <h2 className="text-3xl font-bold tracking-tight">$12,450.00 <span className="text-lg font-medium text-blue-100">USDC</span></h2>
                    <p className="text-xs text-blue-100 mt-1">Powered by Stellar Network</p>
                </div>
