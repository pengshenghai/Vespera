...
const audiences = [
  {
    role: "Tenants",
    title: "For Tenants",
    description: "Instant background checks and deposit-free options available through our trusted partner network.",
    cta: "Start Renting",
  ...
  },
  {
    role: "Landlords",
    title: "For Landlords",
    description: "Guaranteed rent payouts and automated property management driven by smart contracts.",
    cta: "Maximize Yield",
  ...
  },
  {
    role: "Agents",
    title: "For Agents",
    description: "Faster closings and transparent commission tracking on an immutable ledger.",
    cta: "Partner with Us",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {audiences.map((audience) => (
            ...
            >
              <div className={`mb-6 p-4 rounded-2xl ${audience.iconBg} group-hover:scale-105 transition-transform duration-300`}>
                {audience.icon}
              </div>
